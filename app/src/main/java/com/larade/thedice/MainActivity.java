...
public class MainActivity extends AppCompatActivity {
   ...
   String resultatDice = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextOne = findViewById(R.id.nextact);
        mp = MediaPlayer.create(this, R.raw.roll);
        diceResult = findViewById(R.id.resultatOfDice);
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < rollAnimations; i++) {
                    ...
                    resultatDice = String.valueOf(dice1 + dice2);
                    diceResult.setText(resultatDice);
                    System.out.println(resultatDice);
